...
class ProjectModel extends Model {
	...
	public function detail ($prjUri) {
		...
		$strQry .= "	, P.APPL_BODY_COLR, P.APPL_BTN_BG_COLR, P.APPL_BTN_FONT_COLR, P.APPL_BTN_ALIGN, P.ENT_THME_COLR, P.ENT_THME_HEIGHT, P.ENT_BTN_BG_COLR, P.ENT_BTN_FONT_COLR	\n";
