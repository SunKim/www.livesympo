...
class ProjectModel extends Model {
	...
	public function detail ($prjUri) {
		...
		$strQry .= "	, P.STREAM_URL, P.ONAIR_YN, P.ONAIR_ENT_TRM, P.MAIN_IMG_URI, P.AGENDA_IMG_URI, P.FOOTER_IMG_URI	\n";
		...
		$strQry .= "	, P.APPL_BODY_COLR, P.APPL_BTN_BG_COLR, P.APPL_BTN_FONT_COLR, P.APPL_BTN_ALIGN, P.APPL_BTN_ROUND_YN, P.ENT_THME_COLR, P.ENT_THME_FONT_COLR, P.ENT_THME_HEIGHT, P.ENT_BTN_BG_COLR, P.ENT_BTN_FONT_COLR, P.ENT_BTN_ROUND_YN	\n";
		$strQry .= "	, P.STREAM_BODY_COLR, P.STREAM_BTN_BG_COLR, P.STREAM_BTN_FONT_COLR, P.STREAM_QA_BG_COLR, P.STREAM_QA_FONT_COLR	\n";
		$strQry .= "	, ANONYM_USE_YN	\n";
