...
<div class="container">
    ...
    <section class="content">
        ...
        <img id="my_image" src="/images/dongwha/livesympo_dongwha_20210529.jpeg" width="1140" height="859" border="0" usemap="#map" />
...
function openLecture (fileNm, isReady) {
    // window.open(`/etc/dongwha_202105/${fileNm}`, '_blank');

    if (isReady == '1') {
        alert('준비중입니다.');
    } else {
        window.open(`/uploads/etc/dongwha_202105/${fileNm}`, '_blank');
    }
}
